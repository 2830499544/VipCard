<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllianceSettlement.aspx.cs"
    Inherits="ChainStock.SystemManage.AllianceSettlement" %>
                                ...
                                <ItemTemplate>
                                    <tr class="td">
                                        ...
                                        <td style="color:Green;">
                                            <%# Eval("RechargeMoney", "{0:F2}")%>
                                        </td>
                                       
                                        <td>
                                            <%# Eval("RechargeProportion", "{0:F2}")%>
                                        </td>
