<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopGroupList.aspx.cs" Inherits="ChainStock.SystemManage.ShopGroupList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function GroupAdd() {
            window.location.href = "../SystemManage/GroupAuthority.aspx?PID=36&Gid=0&GroupType=3";
        }
    </script>
                                ...
                                <tr style="color: #333333; background-color: #F7F6F3;">
                                    ...
                                    <td class="user_List_styleRight">
                                        <div class="user_List_Button">
                                            <input id="btnGroupAdd" type="button" class="common_Button_new" value="新增商家权限组" onclick="GroupAdd()"
                                                runat="server" />
                                        </div>
                                    </td>
                                </tr>
