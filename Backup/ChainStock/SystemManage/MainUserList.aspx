<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainUserList.aspx.cs" Inherits="ChainStock.SystemManage.MainUserList" %>
                                ...
                                <tr style="color: #333333; background-color: #F7F6F3;">
                                    ...
                                    <td class="user_List_styleRight">
                                        <div class="user_List_Button">
                                            <input id="btnSysUserAdd" type="button" value="新增运营商管理员" class="common_Button_new" onclick="UserAdd()"
                                                runat="server" />
