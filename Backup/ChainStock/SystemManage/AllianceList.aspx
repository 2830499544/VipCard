<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllianceList.aspx.cs" Inherits="ChainStock.SystemManage.AllianceList" %>
...
<body>
    ...
    <input type="hidden" id="hdShopID" runat="server" value="" />
                ...
                <div class="system_Info">
                    ...
                    <div id="ShopInfo" style="display: none">
                        <table class="tableStyle" cellspacing="0" cellpadding="2" style="width: 700px; margin: auto">
                            <tr>
                                <td class="tableStyle_left">
                                    <span style="color: #ff4800; vertical-align: middle">*</span>联盟商名称：
                                </td>
                                <td class="tableStyle_right">
                                ...
                                <td class="tableStyle_left">
                                    <span style="color: #ff4800; vertical-align: middle">*</span>联盟商联系人：
                                </td>
                                <td class="tableStyle_right">
                            ...
                            <tr>
                                ...
                                <td class="tableStyle_right">
                                    ...
                                    <td class="tableStyle_left">
                                        <span style="color: #ff4800; vertical-align: middle">*</span>联盟商结算周期：
                                    </td>
                                    <td class="tableStyle_right">
                                ...
                                <tr style=" display:none;">
                                    ...
                                    <td class="tableStyle_right">
                                        <input id="txtShopProportion" type="text" value="0" runat="server" title="请输入0~1之间的数值" class="border_radius" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="tableStyle_right" colspan="2">商家充值,运营商按比例提成给联盟商
                                    </td>
                                </tr>
                                ...
                                <tr style="color: #333333; background-color: #F7F6F3;">
                                    ...
                                    <td class="tableStyle_left" style="width: 200px">
                                        <label id="lblsearch" for="txtSearch" class="tips">
                                            联盟商名称/联系人/联系电话/联盟商地址</label>
                                        <asp:TextBox ID="txtSearch" runat="server" class="border_radius" Width="320px"></asp:TextBox>
                                    </td>
                        ...
                        <tr class="td">
                           ...
                           <%-- <td class="tdZoom" showalready="0" shopid='<%# Eval("ShopID")%>' union='<%# Eval("IsAllianceProgram")%>'>--%>
                            ...
                            <td class="listtd" style="width: 250px; ">
                                ...
                                <a href="#" onclick='<%# string.Format(" btnShopBuyCards(\"{0}\",\"{1}\",\"{2}\")",Eval("ShopName"),Eval("ShopID"),Eval("IsAllianceProgram")) %>'
                                    id="hySendCard" runat="server">
                                    &nbsp;  <img src="../images/ico/privilege.png" alt="联盟商购卡" title="联盟商购卡" />联盟商购卡
                                </a>
