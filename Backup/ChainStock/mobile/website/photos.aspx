<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="photos.aspx.cs" Inherits="ChainStock.mobile.website.photos" %>
				...
				<ul class="section photo-list">
                   ...
                   <ItemTemplate>
					...
					<li>
						...
						<div class="photo-img">
							<!-- 相册封面图片尺寸等宽高 -->
							<img src='../<%#Eval("AlbumPhoto")%>'/>
							<!-- 相册内照片数量 -->
							<span><%#GetPhotoCount(Eval("AlbumID"))%></span>
						</div>
						<div class="photo-title">
							<h3><%#Eval("AlbumName")%></h3>
						</div>
						<!-- 相册地址 -->
						<a href="photosDetail.aspx?AlbumID=<%#Eval("AlbumID")%>"></a>
					</li>
                     </ItemTemplate>
                        </asp:Repeater>

					<a href="javascript:void(0);" class="moreAlbum" runat="server" id="moreAlbum">加载更多</a>
				</ul>
			</div>
		</div>
		<!-- 底部浮动导航 -->
