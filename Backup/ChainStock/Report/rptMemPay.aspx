<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptMemPay.aspx.cs" Inherits="ChainStock.Report.rptMemPay" %>
                            ...
                            <asp:Repeater runat="server" ID="gvMemList" OnItemDataBound="gvMemList_ItemDataBound">
                                <ItemTemplate>
                                    <tr class="td">
                                        ...
                                        <td style="text-align: right">
                                            <%# this.getMoneyFormat(Eval("MemConsumeMoney"))%>
                                        </td>
                                        <td style="text-align: right">
                                            <%# getMoneyFormat(Eval("OrderPayCash"))%>
                                        </td>
                                        <td style="text-align: right">
                                            <%# getMoneyFormat(Eval("OrderPayBink"))%>
                                        </td>
                                        <td style="text-align: right">
                                            <%# getMoneyFormat(Eval("OrderPayCard"))%>
                                        </td>
                                        <td style="text-align: right">
                                            <%# getMoneyFormat(Eval("OrderPayCoupon"))%>
                                        </td>
                                        <td style="text-align: left">
                                            <%# Eval("ShopName")%>
                                        </td>
