...
function BindParameter() {
    ...
    if ($("#txtCouponMoney").val() != undefined) {
        ...
        if (couponPayMoney != 0) {
           ...
           parameter.push({ "payType": strOrderType, "IsPoint": $("#ucPay_chkPoint").attr("checked"), "IsCard": $("#ucPay_chkCard").attr("checked"), "IsCash": $("#ucPay_chkCash").attr("checked"), "IsBink": $("#ucPay_chkBink").attr("checked"), "CardMoney": cardPayMoney, "CashMoney": accSub(cashPayMoney, changeMoney), "PointMoney": pointPayMoney, "CouponMoney": couponPayMoney, "BinkMoney": binkPayMoney, "DiscountMoney": parseFloat(strDiscountMoney), "ChangeMoney": $("#txtChangeMoney").val(), "usePoint": $("#txtUsePoint").val(), "usePointAmount": $("#txtUsePointAmount").html() });
