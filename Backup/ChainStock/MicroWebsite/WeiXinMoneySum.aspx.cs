...
{
	public class WeiXinMoneySum : PageBase
	{
		...
		private void BindExpenseHistory(string strSql)
		{
			...
			DataTable dtExpenseHistory = new Chain.BLL.WeiXinGiveMoney().GetListSP(false, "TotalCount", this.NetPagerParameter.PageSize, this.NetPagerParameter.CurrentPageIndex, out Counts, new string[]
			{
				strSql
			}).Tables[0];
		...
		{
			int Counts = this.NetPagerParameter.RecordCount;
			DataTable dtExpenseHistory = new Chain.BLL.WeiXinGiveMoney().GetListSP(isasc, order, this.NetPagerParameter.PageSize, this.NetPagerParameter.CurrentPageIndex, out Counts, new string[]
			{
				strSql
			}).Tables[0];
			this.NetPagerParameter.RecordCount = Counts;
