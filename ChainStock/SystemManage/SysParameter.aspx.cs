...
namespace ChainStock.SystemManage
{
	public class SysParameter : PageBase
	{
        ...
        protected TextBox txtAlipayPrivateKey;
        protected TextBox txtAlipayPublicKey;


        protected TextBox txtAPPID;
   //     protected TextBox txtStoreId;
		...
		protected void BindParameter()
		{
            ...
            txtAPPID.Text = this.curParameter.AlipayAppId;
            ...
            this.txtAlipayPrivateKey.Text = this.curParameter.AlipayPrivateKey;
            this.txtAlipayPublicKey.Text = this.curParameter.AlipayPublicKey;
		...
		protected void btnSysParameter_Click(object sender, EventArgs e)
		{
			...
			else
			{
				...
				else
				{
                    ...
                    modelParameter.AlipayAppid = txtAPPID.Text;
                    ...
                    string alipayprivate = txtAlipayPrivateKey.Text;
                   // if(alipayprivate=="")
                    //    alipayprivate = hialipayprivatekey.Value;

                    string alipaypublic = txtAlipayPublicKey.Text;
//                    if (alipaypublic == "")
  //                      alipaypublic = hialipaypublickey.Value;



                    modelParameter.AlipayPrivateKey = alipayprivate;
                    modelParameter.AlipayPublicKey = alipaypublic;
        ...
        public string  UploadPEM(FileUpload file)
        {
            if (!file.HasFile)
                return "";
            ...
            string path = Server.MapPath("../PayApi/alipay/keys") +"\\"+ newfilename;
            file.SaveAs(path);
            return newfilename;
        }
