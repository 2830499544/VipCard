...
{
	public class MainGroupList : PageBase
	{
		...
		private void GetGroupList()
		{
			...
			string strSql = " 1=1 ";
			strSql += string.Format(" and GroupType=1 and (IsPublic = '1' or CreateUserID in (select UserID from sysUser where UserShopID={0}))", this._UserShopID);
