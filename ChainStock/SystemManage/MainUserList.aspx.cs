...
{
	public class MainUserList : PageBase
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!base.IsPostBack)
			{
				...
				PubFunction.BindAuthoritySelelctByGroupType(this._UserGroupID, this.sltUserGroupID, true, 1);
				PubFunction.BindShopSelectByShopType(this._UserShopID, this.sltShopInfo, false, 1);
		...
		private void GetSysUserList(string strSql)
		{
			...
			strSql += " and SysShop.ShopType=1 and SysUser.UserShopID = SysShop.ShopID and SysUser.UserGroupID = SysGroup.GroupID ";
