<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllianceUserList.aspx.cs" Inherits="ChainStock.SystemManage.AllianceUserList" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<%@ Register src="../Controls/AllianceQuickSearch.ascx" tagname="QuickSearch" tagprefix="uc1" %>
                    ...
                    <div class="user_List_All">
                                ...
                                <tr style="color: #333333; background-color: #F7F6F3;">
                                    ...
                                    <td class="user_List_styleRight">
                                        <div class="user_List_Button">
                                            <input id="btnSysUserAdd" type="button" value="新增联盟商操作员" class="common_Button_new" onclick="UserAdd()"
                                                runat="server" />
                        ...
                        <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#434343"
                            ...
                            <tr>
                                ...
                                <td class="tableStyle_right">
                                    <input id="txtSearchAccount"  runat="server" type="text" runat="server" class="border_radius" />
                                </td>
                                <td class="tableStyle_left">
                                    所属权限组：
                                </td>
