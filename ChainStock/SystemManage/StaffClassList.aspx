<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaffClassList.aspx.cs"
    Inherits="ChainStock.SystemManage.StaffClassList" %>
                        ...
                        <table class="tableStyle" cellspacing="0" cellpadding="2" style="width: 700px; margin: auto">
                            <tr>
                                ...
                                <td class="tableStyle_right">
                                    <input id="txtClassName" type="text" runat="server" class="border_radius" />
                                ...
                                <td class="tableStyle_right">
                                    <select id="sltClassShopID" runat="server" class="selectWidth">
                            ...
                            <tr>
                                ...
                                <td class="tableStyle_right">
                                    <label style="vertical-align: text-bottom;">
                                        <input type="radio" name="radType" id="radTypeYes" runat="server" value="0" />
                                        <label style="vertical-align: middle;">
                                            提成</label></label>&nbsp;&nbsp;
                                    <label style="vertical-align: text-bottom;">
                                        <input type="radio" name="radType" id="radTypeNo" runat="server" value="1" />
                                        <label style="vertical-align: middle;">
                                            不提成</label>
                                    </label>
                                </td>
                                ...
                                <td class="tableStyle_right">
                                    <input id="txtClassPercent" type="text" runat="server" class="input_txt border_radius"
                            ...
                            <tr>
                                ...
                                <td class="tableStyle_right" colspan="3">
                                    <textarea id="txtClassRemark" rows="3" runat="server" style="width: 520px; word-wrap: break-word;
                    ...
                    <div class="user_List_All">
                                ...
                                <tr style="color: #333333; background-color: #F7F6F3;">
                                    ...
                                    <td class="user_List_styleRight">
                                        <div class="user_List_Button">
                                            <input id="btnClassAdd" type="button" value="新增部门" runat="server" class="common_Button" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#434343"
                            ...
                            <tr>
                                ...
                                <td class="tableStyle_right">
                                    <div class="user_List_Button">
                                        <asp:Button ID="btnStaffClassQuery" runat="server" Text="查   询" class="common_Button"
                        ...
                        <table class="table-style table-hover user_List_txt">
                            <asp:Repeater runat="server" ID="gvStaffClassList">
                                <HeaderTemplate>
                                    <thead class="thead">
                                        <tr class="th">
                                            <th>
                                ...
                                <ItemTemplate>
                                    <tr class="td">
                                        ...
                                        <td class="listtd" style="width: 60px;">
                                            <a href="#" onclick='<%# string.Format(" StaffClassEdit(\"{0}\")",Eval("ClassID")) %>'
                                                id="aStaffClassEdit" runat="server">
                                                <img src="../images/Gift/eit.png" alt="编辑" title="编辑" />
                                            </a><a href="#" onclick='<%# string.Format(" StaffClassDelete(\"{0}\",\"{1}\")",Eval("ClassID"),Eval("ClassName")) %>'
