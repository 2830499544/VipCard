	...
	public class UserList : PageBase
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!base.IsPostBack)
			{
				...
				PubFunction.BindAuthoritySelelct(this._UserShopID, this._UserGroupID, this.sltUserGroupID, true);
				PubFunction.BindShopSelect(this._UserShopID, this.sltShopInfo, false);
		...
		private void GetSysUserList(string strSql)
		{
			...
			strSql += " and SysUser.UserShopID = SysShop.ShopID and SysUser.UserGroupID = SysGroup.GroupID ";
