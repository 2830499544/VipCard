		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!base.IsPostBack)
			{
				...
				else
				{
                    ...
                    string money = base.Request.QueryString["money"];;
					...
					int point = (int)(float.Parse(base.Request["point"].ToString()));
					string attach = string.Format("{0},{1},{2},{3},{4}", new object[]
					{
						MemID,
						Math.Ceiling(float.Parse(money) / 100),
						givemoney,
						orderAccount,
						point
					});
                    ...
                    jsApiPay.total_fee = int.Parse(money);
