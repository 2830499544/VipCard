<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MerchantLogin.aspx.cs" Inherits="ChainStock.MerchantLogin" %>
        ...
        <div class="form">
            ...
            <form name="loginForm" id="login_form" method="post" action="login/ldo" autocomplete="off">
                ...
                <div class="div_merchant">
                    <span></span>
                    <input id="txtMerchant" type="text" maxlength="20" runat="server" value="" placeholder="商户名" class="username" autocomplete="off" />
                </div>
                <div class="div_user">
                    <span></span>
