<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WeiXinMoneySum.aspx.cs" Inherits="ChainStock.MicroWebsite.WeiXinMoneySum" %>
                        ...
                        <table class="table-style table-hover user_List_txt">
                                ...
                                <ItemTemplate>
                                    <tr class="td">
                                       ...
                                       <td>    <a  href='WeiXinGiveMoneyList.aspx?MoneyID=<%=MoneyID%>&MemID=<%#Eval("MemID") %>'  id="A1">
