    ...
    <div class="login_bg">
        <div class="form">
            ...
            <form name="loginForm" id="login_form" method="post" action="login/ldo" autocomplete="off">
                ...
                <div class="div_user">
                    <span></span>
                    <%--<input id="Password1" name="txtPassword" type="password" maxlength="20" placeholder="重复管理员密码" autocomplete="off" value="" class="pw" runat="server" />--%>
                    <select id="selectVer" class="pw" style="height:40px;width:150px;color:black">
                        <option value ="0" selected>单店版</option>
                        <option value ="1">多店版</option>
                    </select>
                </div>
