<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsumeMemCount.aspx.cs" Inherits="ChainStock.MemExpense.ConsumeMemCount" %>

<%@ Register Src="../Controls/FindMember.ascx" TagName="FindMember" TagPrefix="uc2" %>
...
<head runat="server">
    ...
    <script src="../Scripts/Module/MemExpense/ConsumeMemCount.js" type="text/javascript"></script>
...
<body>
    <form id="ftmConsumeMemCount" runat="server">
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="tab_consume expense">
                                        <div class="tab-body">
                                            <div class="tab-pal" id="dvService">
                                                ...
                                                <div id="ServingProductPage" style="margin: 0px; border: solid 1px #ccc; height: 30px;
                                                    text-align: right; padding-right: 2px; line-height: 30px;">
