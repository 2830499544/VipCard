...
////判断打印纸类型  动态加载打印的JS文件
//function ChenkPrintType() {

//    var PointType = SysParameter().PrintPaperType;
//    if (PointType == 0)//A4试纸
//    {
//        jQuery.getScript("../Scripts/Module/Report/PrintStylus.js");
//        // document.write("<script src='../Scripts/Module/Report/PrintStylus.js'><\/script>");
//    }
//    if (PointType == 1)//三联打印试纸
//    {
//        jQuery.getScript("../Scripts/Module/Report/Print_SanLian.js");
//        //document.write("<script src='../Scripts/Module/Report/Print_SanLian.js'><\/script>");
//    }
//    if (PointType == 2)//POs58
//    {
//        jQuery.getScript("../Scripts/Module/Report/Print.js");
//        //document.write("<script src='../Scripts/Module/Report/Print.js'><\/script>");
//    }
//    if (PointType == 3)//POs80
//    {
//        jQuery.getScript("../Scripts/Module/Report/Prints80.js");
//        //document.write("<script src='../Scripts/Module/Report/Print.js'><\/script>");
//    }
//}
...
function MemPassTimeListSendSMS() {
    var mobile = "";
    var mobiles = "";
    var name = "";
    var memcard = "";
...
String.prototype.ToNumber = function () {
    return (this == null || this == "NaN" || this == "undefined" || this == "") ? 0 : parseInt(this);
}
...
Date.prototype.Format = function (formattype) {
    ...
    switch (formattype) {
        case 0:
            ...
            break;
        case 1:
            if (thismonth.toString() == "00") {
                thismonth = "12";
                thisyear = accSub(thisyear, 1);
            }
            dateString = thisyear + "-" + thismonth + "-" + thisday;
...
//绑定空列表
function BindNullList(controlID, showHeard) {
    if ($("#" + controlID) != null) {
        var ControlList = $("#" + controlID);
        var intTdNumber = ControlList.find("th").length;
        var a = ControlList.find("tr").length;
        if (ControlList.find("tr").length == 1) {
            ControlList.append("<tr  class='td'><td colspan='" + intTdNumber + "' style='text-align:center'><font color='#00000'>未找到符合此条件的数据！</font></td></tr>");
        }
        ...
        if (pager > 0) {
            ...
            if (showHeard) {
                ControlList.prepend("<tr class='th'><th id='tdheard' colspan='" + intTdNumber + "' style='text-align:left;height:20px;width:100%'></th>");
            }
            $("#tabPager").remove();
        }
    }
...
线形图
*/
function LodaChartData(SeriesType, mytitle, myunit, myInterval, mySeries) {
    $('#container').highcharts = new Highcharts.Chart({
        ...
        xAxis: {//X轴数据
            labels: {
                rotation: -45, //字体倾斜
                align: 'right',
                style: { font: 'normal 13px Microsoft YaHei' }
            },
