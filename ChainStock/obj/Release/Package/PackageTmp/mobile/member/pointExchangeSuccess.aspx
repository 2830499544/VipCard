<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pointExchangeSuccess.aspx.cs" Inherits="ChainStock.mobile.member.pointExchangeSuccess" %>
	...
	<div class="section index" id="container">
		...
		<div id="content" class="section">
			<div class="section reg_success t-center">
				...
				<p>恭喜您！积分兑换成功！</p>
				<a href="pointExchangeRecord.aspx" class="integral-record">查看兑换记录</a>
			</div>
