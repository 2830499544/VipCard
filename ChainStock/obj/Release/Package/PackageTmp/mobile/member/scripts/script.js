...
function SetRemainTime() {
    ...
    if (curCount == 0) {
        ...
        $("#getCode").attr("onclick", "sendregisterMessage()");
...
//注册会员
 $("#memRegister").click(function () {
        ...
        { "mobile": mobile, "pwd": pwd, "memname": memname,"shopid":shopid
        }, function (text) {
...
function getShop() {
    ...
    $.get("../../Service/AjaxService.ashx?Method=Wx_getSHop",
     {
         "t": Math.random()
     }, function (text) {
         ...
         switch (text) {
             ...
             default:
                 ...
                 if (json != "") {
                     for (var i = 0; i < json.length; i++) {
                         $("#sltShop").append("<option value='" + json[i].ShopID + "'>" + json[i].ShopName + "</option>");
                     }
                 }
                 break;
         }
