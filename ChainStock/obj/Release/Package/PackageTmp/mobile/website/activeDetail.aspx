<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="activeDetail.aspx.cs" Inherits="ChainStock.mobile.website.activeDetail" %>
...
<body>
	<div class="section" id="container">
		...
		<div id="content" class="section">
			<div class="section active-detail">
				<div class="section active-box">
					<!-- 这里面放置活动详情的图片与文字 -->
                      <p>&nbsp;</p>
              <h5>优惠对象：<span  runat="server" id="spMemLevel">1</span></h5>
              <p>&nbsp;</p>
                    <p runat="server" id="spPromotionsDesc"></p>
                  
				<%--	<img src="images/active.jpg" style="width:100%;" />--%>
				</div>

				<div class="section active-head">
					<h3>您可以到这些商家去参加活动：</h3>
					<!-- 参与活动的商家列表 -->
                    ...
                    <ItemTemplate>
							...
							<%--<a href="javascript:void(0);">点击获取更多活动商家...</a>--%>
						</ul>
					</div>
				</div>
			</div>
