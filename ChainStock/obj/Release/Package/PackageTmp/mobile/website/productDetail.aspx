<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="productDetail.aspx.cs" Inherits="ChainStock.mobile.website.productDetail" %>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8" />
...
<body>
	<div class="section" id="container">
		...
		<div id="head" class="section">
			<h1>产品详情</h1>
			<!-- 返回上一页 -->
			<a href="productShow.aspx" class="back-btn"><img src="images/prev.png" /></a>
			<!-- 跳转到微会员 -->
		...
		<div id="content" class="section">
			<div class="section product-detail">
                ...
                <p id="spProductDesc" runat="server"></p>
