<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptMemDrawMoney.aspx.cs"
    Inherits="ChainStock.Report.RptMemDrawMoney" %>
...
<body>
    <form id="frmMemDrawMoney" runat="server">
  ...
  <input  id="HDsltshop" runat="server" type="hidden" />
                                        ...
                                        <td class="user_List_styleRight">
                                            <div class="user_List_Button">
                                                ...
                                                <asp:Button ID="btnMemDrawMoneyExcel" runat="server" OnClientClick="return btQuery();"
                                                    Text="导   出" class="common_Button" OnClick="btnMemDrawMoneyExcel_Click" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <tr>
                                <th align="left">
                                    &nbsp;&nbsp;&nbsp;&nbsp; <font color="#00000">会员提现统计：<b>提现总金额： <font color="red">
                                        <asp:Label ID="lblDrawTotalMoney" runat="server" Text="0"></asp:Label></font>元,&nbsp;&nbsp;实际扣除总金额：
                                        <font color="red">
                                            <asp:Label ID="lblDrawActualMoney" runat="server" Text="0"></asp:Label></font>元
                                    </font>
                                </th>
                            </tr>
                        </table>
                        <div runat="server" id="report">
                            <table class="table-style table-hover user_List_txt" cellspacing="0" cellpadding="2">
                                <asp:Repeater runat="server" ID="gvRptMemDrawMoney">
                                    <HeaderTemplate>
                                        <thead class="thead">
                                            <tr class="th">
                                                <th>
                                    ...
                                    <ItemTemplate>
                                        <tr class="td">
                                            ...
                                            <td style="text-align: right">
                                                <%# Eval("DrawActualMoney","{0:F2}")%>
                                            </td>
                                            <td style="text-align: left;">
                                                <%# Eval("DrawMoneyRemark")%>
                                            </td>
                                            <td>
                                                <%# Eval("DrawMoneyCreateTime", "{0:yyyy-MM-dd HH:mm:ss}")%>
                                            </td>
                                            <td>
                                                <%# Eval("ShopName")%>
                                            </td>
