...
insert into Mem(MemID,MemCard,MemPassword,MemName,MemSex,MemIdentityCard,MemMobile,MemPhoto,MemBirthdayType,MemBirthday,MemIsPast,MemPastTime,MemPoint,MemPointAutomatic,MemMoney,MemConsumeMoney,MemConsumeLastTime,MemConsumeCount,MemEmail,MemAddress,MemState,MemRecommendID,MemLevelID,MemShopID,MemCreateTime,MemRemark,MemUserID,MemTelePhone,MemQRCode,MemProvince,MemCity,MemCounty,MemVillage,MemQuestion,MemAnswer,MemCardNumber,MemAttention,MemWeiXinCards) values (0,0,'E62A9E6C1892C6BB','散客',1,NULL,NULL,NULL,NULL,'1900-1-1 0:00:00',0,'2900-1-1 0:00:00',0,NULL,0,NULL,NULL,NULL,NULL,NULL,0,NULL,-1,1,'2013-4-20',NULL,1,NULL,'','','','','','','','','2','') 
insert into Mem(MemID,MemCard,MemPassword,MemName,MemSex,MemIdentityCard,MemMobile,MemPhoto,MemBirthdayType,MemBirthday,MemIsPast,MemPastTime,MemPoint,MemPointAutomatic,MemMoney,MemConsumeMoney,MemConsumeLastTime,MemConsumeCount,MemEmail,MemAddress,MemState,MemRecommendID,MemLevelID,MemShopID,MemCreateTime,MemRemark,MemUserID,MemTelePhone,MemQRCode,MemProvince,MemCity,MemCounty,MemVillage,MemQuestion,MemAnswer,MemCardNumber,MemAttention,MemWeiXinCards) values (1,'100010','2CBE9C73F856E743','周杰伦',1,'','','',1,'1900-1-1 0:00:00',0,'2900-1-1 0:00:00',0,1,0.0000,NULL,NULL,NULL,'','',0,0,0,1,'2013-5-3 0:00:00','' ,1,'','','','','','','','','','2','') 
insert into Mem(MemID,MemCard,MemPassword,MemName,MemSex,MemIdentityCard,MemMobile,MemPhoto,MemBirthdayType,MemBirthday,MemIsPast,MemPastTime,MemPoint,MemPointAutomatic,MemMoney,MemConsumeMoney,MemConsumeLastTime,MemConsumeCount,MemEmail,MemAddress,MemState,MemRecommendID,MemLevelID,MemShopID,MemCreateTime,MemRemark,MemUserID,MemTelePhone,MemQRCode,MemProvince,MemCity,MemCounty,MemVillage,MemQuestion,MemAnswer,MemCardNumber,MemAttention,MemWeiXinCards) values (2,'100020','2CBE9C73F856E743','萧敬腾',1,'','','',1,'1900-1-1 0:00:00',0,'2900-1-1 0:00:00',0,1,0.0000,NULL,NULL,NULL,'','',0,0,0,1,'2013-5-3 0:00:00','',1,'','','','','','','','','','2','') 
insert into Mem(MemID,MemCard,MemPassword,MemName,MemSex,MemIdentityCard,MemMobile,MemPhoto,MemBirthdayType,MemBirthday,MemIsPast,MemPastTime,MemPoint,MemPointAutomatic,MemMoney,MemConsumeMoney,MemConsumeLastTime,MemConsumeCount,MemEmail,MemAddress,MemState,MemRecommendID,MemLevelID,MemShopID,MemCreateTime,MemRemark,MemUserID,MemTelePhone,MemQRCode,MemProvince,MemCity,MemCounty,MemVillage,MemQuestion,MemAnswer,MemCardNumber,MemAttention,MemWeiXinCards) values (3,'100030','2CBE9C73F856E743','王菲',0,'','','',1,'1900-1-1 0:00:00',0,'2900-1-1 0:00:00',0,1,0.0000,NULL,NULL,NULL,'','',0,0,0,1,'2013-5-3 0:00:00','',1,'','','','','','','','','','2','') 
...
insert into GoodsClass(ClassID,ClassName,ClassRemark,ParentID,CreateShopID) values (2,'休闲食品','这是小类名称',1,1)
insert into GoodsClass(ClassID,ClassName,ClassRemark,ParentID,CreateShopID) values (3,'饼干甜点','这是小类名称',1,1)
insert into GoodsClass(ClassID,ClassName,ClassRemark,ParentID,CreateShopID) values (4,'糖果','这是小类名称',1,1)
...
insert into Goods(GoodsID,GoodsCode,GoodsClassID,[Name],NameCode,Unit,GoodsNumber,GoodsSaleNumber,Price,CommissionType,CommissionNumber,Point,MinPercent,GoodsType,GoodsBidPrice,GoodsRemark,GoodsPicture,GoodsCreateTime,CreateShopID,SalePercet) values (1,'130503163627',2,'上好佳','SHJ','袋',0,0,5.00,0,0,-1,0,0,3.00,'','','2013-05-03 16:41:03.077',1,0)
insert into Goods(GoodsID,GoodsCode,GoodsClassID,[Name],NameCode,Unit,GoodsNumber,GoodsSaleNumber,Price,CommissionType,CommissionNumber,Point,MinPercent,GoodsType,GoodsBidPrice,GoodsRemark,GoodsPicture,GoodsCreateTime,CreateShopID,SalePercet) values (2,'130503165141',3,'夹心饼干','KFALAZFSGJX','盒',0,0,35.00,0,0,-1,0,0,10,'','','2013-05-03 16:53:26.720',1,0)
...
insert into GiftClass(GiftClassID,GiftClassName,GiftClassRemark,GiftParentID) values (1,'陶瓷','',0)
SET IDENTITY_Insert GiftClass OFF
--PointGift
DELETE PointGift DBCC CHECKIDENT(PointGift,RESEED,0)
SET IDENTITY_Insert PointGift ON
insert into PointGift (GiftID,GiftName,GiftCode,GiftClassID,GiftPhoto,GiftExchangePoint,GiftStockNumber,GiftExchangeNumber,GiftShopID,GiftRemark) values (1,'瓷韵笔+无线鼠标','CYB+WXSB',1,'',5000,5,0,1,'')
insert into PointGift (GiftID,GiftName,GiftCode,GiftClassID,GiftPhoto,GiftExchangePoint,GiftStockNumber,GiftExchangeNumber,GiftShopID,GiftRemark) values (2,'陶瓷笔+无线键盘','TCB+WXJP',1,'',8000,5,0,1,'')
...
INSERT INTO dbo.WeiXinRule(RuleNUmber,RuleNewsType,RuleDesc,RuleContent,RuleUserID,RuleCreateTime)VALUES(1,'text','回复1 申请/出示会员卡','请发送您的手机号码','1',GETDATE());
INSERT INTO dbo.WeiXinRule(RuleNUmber,RuleNewsType,RuleDesc,RuleContent,RuleUserID,RuleCreateTime)VALUES(2,'text','回复2 已有会员转微信会员','请发送您的手机号或卡号','1',GETDATE());
--WeiXinNews
