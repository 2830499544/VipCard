        ...
        <tr>
            <td>
                <table class="tableStyle">
                    ...
                    <tr id="trAlipay" runat="server">
                        <td class="tableStyle_left" style="text-align: right;">
                            <label>
                                <input id="chkAlipay" name="chkAlipay" type="checkbox" runat="server" style="width: 20px" />
                                支付宝金额：</label>
                        </td>
                        <td class="tableStyle_right">
                            <input type="text" style="font-size: 20px; float: none;" id="txtByAlipayMoney" class="border_radius"  disabled="disabled"/>
                        </td>
                    </tr>
                     <tr id="tralipaymoney" runat="server">
                        <td class="tableStyle_left" style="text-align: right;">
                            <label>
                               支付宝码：</label>
                        </td>
                        <td class="tableStyle_right">
                            <input type="text" style="font-size: 20px; float: none;" id="txtAlipayCode" class="border_radius" disabled="disabled" />
                            
                        </td>
                    </tr>

                    <tr id="trWx" runat="server">
                        <td class="tableStyle_left" style="text-align: right;">
                            <label>
                                <input id="chkWeixin" name="chkWeixin" type="checkbox" runat="server" style="width: 20px" />
                                微信金额： </label>
                        </td>
                        <td class="tableStyle_right">
                            <input type="text" style="font-size: 20px; float: none;" id="txtByWeixinMoney" class="border_radius" disabled="disabled" />
                        </td>
                    </tr>
                      <tr id="trwxmoney" runat="server">
                        <td class="tableStyle_left" style="text-align: right;">
                            <label>
                               微&nbsp;信&nbsp;码：</label>
                        </td>
                        <td class="tableStyle_right"><input type="text" style="font-size: 20px; float: none;" id="txtWeiXinCode" class="border_radius"  disabled="disabled"/>
                            
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="color:#ff0000;height:20px;">支付宝和微信不支持找零，请注意</td>
                    </tr>
